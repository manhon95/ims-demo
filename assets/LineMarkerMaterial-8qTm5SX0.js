import{q7 as Q,q8 as P,q9 as J,qa as X,qb as K,qc as ee,qd as te,d6 as r,qe as re,qf as ie,qg as c,qh as ae,qi as H,qj as se,qk as ne,ql as g,qm as oe,qn as ce,qo as le,qp as pe,qq as de,qr as he,qs as k,qt as ve,qu as ue,qv as me,qw as fe,qx as Se,ee as Te,qy as y,qz as q,qA as ge,qB as Pe,qC as _e,qD as I,qE as Oe,qF as Ae,qG as x,qH as U,qI as W,qJ as Ee,qK as M,qL as j,qM as we,qN as ye,qO as Re,qP as xe,qQ as S,qR as $e,qS as qe,qT as $,cX as R,qU as Ie,qV as F,qW as G,qX as ze,dI as Ce,qY as De,qZ as Le,dx as B,q_ as Ne,hC as V,d2 as Z}from"./index-rQblpct7.js";function be(l){const e=new Q,{space:t,anchor:p,hasTip:T}=l,m=t===P.World;e.include(J,l),e.include(X,l),e.include(K,l);const{vertex:i,fragment:d}=e;d.include(ee),te(i,l),e.attributes.add(r.POSITION,"vec3"),e.attributes.add(r.PREVPOSITION,"vec3"),e.attributes.add(r.UV0,"vec2"),e.varyings.add("vColor","vec4"),e.varyings.add("vpos","vec3"),e.varyings.add("vUV","vec2"),e.varyings.add("vSize","float"),T&&e.varyings.add("vLineWidth","float"),i.uniforms.add(new re("nearFar",({camera:o})=>o.nearFar),new ie("viewport",({camera:o})=>o.fullViewport)),i.code.add(c`vec4 projectAndScale(vec4 pos) {
